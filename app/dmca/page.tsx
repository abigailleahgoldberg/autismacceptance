...
export const metadata: Metadata = {
  title: 'DMCA Policy | Autism Acceptance',
  description: 'DMCA copyright policy for Autism Acceptance.',
};
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ background: 'rgba(107,33,168,0.08)', border: '1px solid rgba(168,85,247,0.2)', borderRadius: '8px', padding: '2rem', marginBottom: '2rem' }}>
          <p style={{ lineHeight: 1.8 }}>
            Autism Acceptance respects the intellectual property rights of others. In accordance with the Digital Millennium Copyright Act of 1998 (DMCA), we will respond promptly to valid claims of copyright infringement.
          </p>
        </div>
