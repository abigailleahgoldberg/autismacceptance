...
export const metadata: Metadata = {
  title: 'Terms of Service | Autism Acceptance',
  description: 'Terms of Service for Autism Acceptance. Please read these terms carefully before using our website.',
};
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ background: 'rgba(107,33,168,0.08)', border: '1px solid rgba(168,85,247,0.2)', borderRadius: '8px', padding: '2rem', marginBottom: '2rem' }}>
          <p style={{ lineHeight: 1.8 }}>
            Please read these Terms of Service carefully before using https://autismacceptance.world operated by The Voice of Cash (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;). By accessing or using our service, you agree to be bound by these terms.
          </p>
        </div>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ lineHeight: 1.8 }}>
            By accessing and using https://autismacceptance.world, you accept and agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, please do not use our website.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ lineHeight: 1.8 }}>
            Autism Acceptance provides online content, information, and services through our website. We reserve the right to modify, suspend, or discontinue any aspect of the service at any time without notice.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ lineHeight: 1.8 }}>
            All content on https://autismacceptance.world, including but not limited to text, graphics, logos, images, audio clips, and software, is the property of The Voice of Cash / Autism Acceptance and is protected by United States and international copyright laws. You may not reproduce, distribute, or create derivative works without our express written permission.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ lineHeight: 1.8 }}>
            To the fullest extent permitted by law, The Voice of Cash and Autism Acceptance shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of, or inability to use, this website or its content. Our total liability shall not exceed the amount paid by you, if any, for accessing our services.
          </p>
        </section>
